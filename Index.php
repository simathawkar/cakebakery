...
<body>
    <div class="all-content">
        ...
        <section class="experience-flavour">
            ...
            <a href="Red Velvet.php"><button class="ellipse-button">Red Velvet</button></a>
            <a href="Black.php"><button class="ellipse-button">Black Forest</button></a>
            <a href="Kit.php"><button class="ellipse-button">Kit Kat </button></a>
        </section>
                    ...
                    <div class="col-md-3 py-3 py-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <span><a href="test.php?product=Chocolate Cake&price=180&image=images/c2.png">
                                    <button>Order Now</button>
                                </a></span>
                    ...
                    <div class="col-md-3 py-3 py-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <span><a href="test.php?product=Slice Cake&price=180&image=images/c3.jpg">
                                    <button>Order Now</button>
                                </a></span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 py-3 py-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <span><a href="test.php?product=Fruit Cake&price=180&image=images/c4.png">
                                    <button>Order Now</button>
                                </a></span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 py-3 py-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <span><a href="test.php?product=Chees Cake&price=180&image=images/c5.png">
                                    <button>Order Now</button>
                                </a></span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 py-3 py-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <span><a href="test.php?product=Vanilla Cake&price=180&image=images/c6.png">
                                    <button>Order Now</button>
                                </a></span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 py-3 py-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <span><a href="test.php?product=Lemon Cake&price=180&image=images/c7.png">
                                    <button>Order Now</button>
                                </a></span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 py-3 py-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <span><a href="test.php?product=Black Forest Cake&price=180&image=images/c8.png">
                                    <button>Order Now</button>
                                </a></span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 py-3 py-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <span><a href="test.php?product=Red Velvet Cake&price=180&image=images/c9.png">
                                    <button>Order Now</button>
                                </a></span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 py-3 py-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <span><a href="test.php?product=Coffe Cake&price=180&image=images/c10.png">
                                    <button>Order Now</button>
                                </a></span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 py-3 py-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <span><a href="test.php?product=Truffle Cake&price=180&image=images/c11.png">
                                    <button>Order Now</button>
                                </a></span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 py-3 py-md-0">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <span><a href="test.php?product=Pineapple Cake&price=180&image=/images/c12.png">
                                    <button>Order Now</button>
                                </a></span>
                            </div>
                        </div>
        ...
        <section class="experience-flavour">
            ...
            <a href="birthday.php"><button class="ellipse-button">Birthday</button></a>
            <a href="baby.php"><button class="ellipse-button">Baby Shower</button></a>
            <a href="anniversary.php"><button class="ellipse-button">Anniversary</button></a>
            <a href="Retirement.php"><button class="ellipse-button">Retirement</button></a>
            <a href="Farewell.php"><button class="ellipse-button">Farewell</button></a>
        </section>
